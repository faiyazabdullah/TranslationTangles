...
## Language Pairs
<p>The project evaluates the following language pairs, taken from the <code>wmt18</code> and <code>wmt19</code> dataset. For more information visit: <a href="https://huggingface.co/wmt" target="_blank">wmt datasets on Hugging Face</a>.</p>
...
<ul>
        ...
        <li>English-Bangla (<code>en-bn</code>)</li>
</ul>
